...
BLENDER_PATH = "/data2/wh/hoi_diffusion_model/blender-3.6.3-linux-x64/blender" # Put your blender path here 
BLENDER_UTILS_ROOT_FOLDER = "/data2/wh/hoi_diffusion_model/manip/vis" # Put the manip/vis folder absolute path here 
