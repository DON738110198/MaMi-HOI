...
def add_base_options(parser):
    ...
    group.add_argument("--exp_name", default="", type=str)
...
def add_model_options(parser):
    ...
    group.add_argument("--lambda_relative_loss", default=0.1, type=float, help="Joint velocity loss.")



def add_data_options(parser):
    group = parser.add_argument_group('dataset')
    group.add_argument("--dataset", default='OMOMO', choices=['humanml', 'kit', 'humanact12', 'uestc'], type=str,
                       help="Dataset name (choose from list).")
    group.add_argument("--data_dir", default='Path/data/OMOMO/my_norm_data', type=str,
                       help="If empty, will use defaults according to the specified dataset.")
    group.add_argument("--dataset_window", default=300, type=int, help="Number of learning rate anneal steps.")


def add_training_options(parser):
    group = parser.add_argument_group('training')
    group.add_argument("--save_dir", default='./exp_result', type=str,
    ...
    group.add_argument("--eval_batch_size", default=4, type=int,
...
def get_cond_mode(args):
    if args.unconstrained:
        cond_mode = 'no_cond'
    elif args.dataset in ['kit', 'humanml','OMOMO']:
        cond_mode = 'text'
    else:
        cond_mode = 'action'
    return cond_mode
