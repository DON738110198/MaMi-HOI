...
def filter_sampled_paths():
    ...
    height_json_path = "/data2/wh/hoi_diffusion_model/processed_data/replica_processed/scene_floor_height.json"
    scene_floor_dict = json.load(open(height_json_path, 'r'))

    dest_json_path = "/data2/wh/hoi_diffusion_model/other_projects/chois_release/utils/create_eval_dataset/selected_long_seq_names.json"
    dest_json_dict = {} 
    cnt = 0 
    
    npy_root_folder = "/data2/wh/hoi_diffusion_model/processed_data/replica_processed/replica_single_object_long_seq_data"
...
if __name__ == "__main__":
    ...
    data_root_folder = "/data2/wh/hoi_diffusion_model/processed_data/replica"
    output_folder = "/data2/wh/hoi_diffusion_model/processed_data/replica_processed/replica_single_object_long_seq_data"
    out_json_path = "./eval_dataset_response_text_idx.json"
