...
if __name__ == '__main__':
    ...
    eval_motion_loaders = {
        # 'CHOIS_my_train': lambda: get_motion_loader_for_chois_eval(
        #     '/data2/wh/hoi_diffusion_model/chois_my_results/res_npz_files/chois',
        #     batch_size,
        # ),
        'CONTROL_CHOIS': lambda: get_motion_loader_for_chois_eval(
            '/data2/wh/hoi_diffusion_model/chois_single_window_results/res_npz_files/control_chois',
            batch_size,
        ),
        # 'CHOIS_GUANFANG': lambda: get_motion_loader_for_chois_eval(
        #     '/data2/wh/hoi_diffusion_model/chois_guanfang/res_npz_files/chois',
        #     batch_size,

        # 'CONTROL_CHOIS_unseen': lambda: get_motion_loader_for_chois_eval(
        #     '/data2/wh/hoi_diffusion_model/chois_single_window_results/res_npz_files_unseen_obj/chois',
        #     batch_size,
        # ),
        # 'CHOIS_guanfang_res': lambda: get_motion_loader_for_chois_eval(
        #     '/data2/wh/hoi_diffusion_model/t2m_eval/res_npz_files/chois',
        #     batch_size,

        # 'CHOIS_guanfang_res_unseen': lambda: get_motion_loader_for_chois_eval(
        #     '/data2/wh/hoi_diffusion_model/t2m_eval/res_npz_files/chois_unseen_obj',
        #     batch_size,
        # ),
        'CONTROL_GAPA_CHOIS': lambda: get_motion_loader_for_chois_eval(
            '/data2/wh/hoi_diffusion_model/control_GAPA_chois_my_results/res_npz_files/chois',
            batch_size,
        ),
        'CONTROL_GAPA_CHOIS_unseen': lambda: get_motion_loader_for_chois_eval(
            '/data2/wh/hoi_diffusion_model/control_GAPA_chois_my_results/res_npz_files_unseen_obj/chois',
            batch_size,
        ),
    ...
    gt_loader = get_motion_loader_for_chois_eval(
            '/data2/wh/hoi_diffusion_model/chois_omomo_results_gt_HPC/res_npz_files',
            batch_size)
    # gt_loader = get_motion_loader_for_chois_eval(
    # '/data2/wh/hoi_diffusion_model/t2m_eval/res_npz_files/gt',
    # batch_size)
    ...
    log_file = './t2m_evaluation_guanfang_GT_guanfang_t2mMeanStd.log'
    evaluation(log_file)
