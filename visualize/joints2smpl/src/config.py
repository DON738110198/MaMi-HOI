...
SMPL_MODEL_DIR = "/data2/wh/hoi_diffusion_model/data/body_models/"
GMM_MODEL_DIR = "/data2/wh/hoi_diffusion_model/visualize/joints2smpl/smpl_models"
SMPL_MEAN_FILE = "/data2/wh/hoi_diffusion_model/visualize/joints2smpl/smpl_models/neutral_smpl_mean_params.h5"
# for collsion 
Part_Seg_DIR = "/data2/wh/hoi_diffusion_model/visualize/joints2smpl/smpl_models/smplx_parts_segm.pkl"